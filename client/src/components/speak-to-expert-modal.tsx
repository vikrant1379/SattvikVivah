...
const SpeakToExpertModal: React.FC<SpeakToExpertModalProps> = memo(
  ({ isOpen, onClose }) => {
    ...
    const handleWhatsAppClick = () => {
      ...
      toast({
        ...
        description:
          "You'll be connected with our divine guidance counselor shortly.",
      });
      onClose();
    };
    ...
    const handleConsultationSubmit = async (data: IConsultationForm) => {
      ...
      try {
        ...
        toast({
          ...
          description:
            "Our spiritual counselor will connect with your soul within the promised timeframe.",
        });
        ...
        toast({
          ...
          description:
            "The divine path seems blocked. Please try seeking guidance again.",
          variant: "destructive",
        });
      } finally {
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 italic">
                  "The guru is Brahma, Vishnu, and Shiva - divine guidance
                  awaits"
                </p>
              </div>
              ...
              <Card className="bg-gradient-to-r from-orange-50 to-rose-50 border-orange-200/50 shadow-lg">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-700 mb-4 leading-relaxed">
                    To provide you with tailored dharmic advice based on your
                    spiritual profile and sacred aspirations, please login to
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm uppercase">
                  <span className="bg-background px-4 text-orange-700 font-medium font-serif">
                    या फिर
                  </span>
                </div>
              </div>
              ...
              <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200/50 shadow-lg">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-700 mb-4 leading-relaxed">
                    Connect instantly with our spiritual counselor on WhatsApp
                    for immediate dharmic guidance and sacred matrimonial wisdom
                  ...
                  <div className="flex items-center justify-center space-x-2 mb-4">
                    <Badge
                      variant="outline"
                      className="bg-white/80 border-green-200 text-green-700"
                    >
              ...
              <div className="text-center py-4">
                ...
                <p className="text-xs text-gray-600 italic">
                  "May all beings find happiness, may all be free from
                  suffering"
                </p>
              </div>
            </div>
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-4xl max-h-[95vh] overflow-y-auto">
            ...
            {user && (
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground italic">
                  Let our spiritual guides illuminate your sacred path to
                  dharmic union
                </p>
              </div>
            )}
          ...
          <div className="space-y-6">
            ...
            {currentStep === "success" && (
              <div className="text-center py-10">
                ...
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Our spiritual counselor is meditating on your sacred query and
                  will connect with your soul shortly. May your dharmic journey
                  be blessed with divine wisdom.
                </p>
            ...
            {currentStep === "assessment" && (
              <SpiritualAssessment onAssessmentChange={setAssessment} />
            )}
