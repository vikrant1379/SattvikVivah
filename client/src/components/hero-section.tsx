...
const HeroSection = memo(() => {
  ...
  return (
    <section className="vedic-gradient py-10 md:py-16 lg:py-20 px-4">
      <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-6 md:space-y-8 order-2 lg:order-1">
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="mandala-divider py-2 md:py-4">
              <div className="flex items-center justify-center space-x-4 md:space-x-6">
                <span className="text-temple-gold font-devanagari text-xl md:text-2xl animate-om-pulse">ॐ</span>
                <blockquote className="text-sm md:text-base text-foreground/70 italic font-serif text-center max-w-md">
          ...
          <Card className="bg-card-cream/50 backdrop-blur-sm border-temple-gold/20 shadow-2xl w-full max-w-md mx-auto lg:max-w-none">
            <CardHeader className="pb-3 md:pb-4 px-4 md:px-6">
              <CardTitle className="font-serif font-semibold text-xl text-foreground mandala-border pb-2 md:pb-4">
        ...
        <div className="relative order-1 lg:order-2 flex justify-center lg:justify-end">
          <img
            ...
            className="rounded-2xl shadow-2xl w-full max-w-lg lg:max-w-xl animate-float"
          />
          <div className="absolute -top-4 -left-4 w-16 h-16 md:-top-6 md:-left-6 md:w-24 md:h-24 bg-temple-gold/20 rounded-full flex items-center justify-center animate-lotus-bloom border border-temple-gold/30">
            <span className="text-temple-gold text-xl md:text-2xl font-devanagari">ॐ</span>
          </div>
          <div className="absolute -bottom-4 -right-4 w-24 h-24 md:-bottom-6 md:-right-6 md:w-32 md:h-32 bg-saffron/10 rounded-full flex items-center justify-center animate-float border border-saffron/30" style={{animationDelay: "-2s"}}>
            <span className="text-saffron text-2xl md:text-3xl">🪷</span>
          </div>
        </div>
      </div>
    </section>
