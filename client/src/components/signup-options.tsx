  ...
  const handleSignup = async (data: SignupForm) => {
    try {
      ...
      toast({
        ...
        description:
          "Please verify your email or mobile number to complete your registration.",
      });
    } catch (error) {
      toast({
        title: "Signup Failed",
    ...
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader className="text-center">
        ...
        <p className="text-muted-foreground">
          Create your sacred profile to find your dharmic partner
        </p>
      </CardHeader>
      <CardContent>
        <Form {...form}>
                    ...
                    <FormControl>
                      <div className="flex border border-input rounded-md overflow-hidden focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 bg-background">
                        ...
                        <Input
                          ...
                          {...field}
                          onChange={(e) => {
                            const formatted = formatMobileNumber(
                              e.target.value,
                            );
