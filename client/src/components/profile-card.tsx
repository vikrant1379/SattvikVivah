  ...
  const formatLastSeen = () => {
    ...
    if (wasSeenToday) {
      ...
      return lastSeenOptions[
        Math.floor(Math.random() * lastSeenOptions.length)
      ];
    }
  };
        ...
        <div className="flex">
          ...
          <div className="flex-1 pl-4 pr-0 py-4">
            ...
            <div className="absolute top-4 right-0 flex flex-col items-end space-y-2">
              {profile.verified && (
                <Badge
                  className="bg-red-500 text-white rounded-l-full rounded-r-none"
                  style={{
                    fontSize: "12px",
                    fontWeight: 600,
                    lineHeight: "16px",
              ...
              {Math.random() > 0.5 && (
                <Badge
                  className="border border-blue-200 rounded-l-full rounded-r-none flex items-center"
                  style={{
                    fontSize: "12px",
                    fontWeight: 600,
                    lineHeight: "16px",
            ...
            {/* Basic Info Row */}
            <div
              className="flex items-center mb-2 pr-4"
              style={{
                fontSize: "14px",
                fontWeight: 600,
                lineHeight: "20px",
            ...
            {/* Action Buttons */}
            <div className="flex items-center pr-4" style={{ gap: "12px" }}>
              <Button
                variant="outline"
                size="sm"
